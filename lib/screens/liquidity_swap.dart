...
class SwapLiquidity extends StatefulWidget {
  const SwapLiquidity({Key? key}) : super(key: key);

  @override
  State<SwapLiquidity> createState() => _SwapLiquidityState();
}

class _SwapLiquidityState extends State<SwapLiquidity> {
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              log('select currency token');
                              DialogHelperCurrency.exit(context);
